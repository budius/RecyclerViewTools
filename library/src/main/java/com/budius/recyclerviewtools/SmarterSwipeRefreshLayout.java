package com.budius.recyclerviewtools;
...
public class SmarterSwipeRefreshLayout extends SwipeRefreshLayout implements AppBarLayout.OnOffsetChangedListener {
   ...
   public SmarterSwipeRefreshLayout(Context context, AttributeSet attrs) {
      super(context, attrs);
      TypedArray a = context.obtainStyledAttributes(attrs, com.budius.recyclerviewtools.R.styleable.SmarterSwipeRefreshLayout);
      targetResId = a.getResourceId(com.budius.recyclerviewtools.R.styleable.SmarterSwipeRefreshLayout_target, -1);
      appbarLayoutResId = a.getResourceId(com.budius.recyclerviewtools.R.styleable.SmarterSwipeRefreshLayout_appBarLayout, -1);
      a.recycle();
   }
